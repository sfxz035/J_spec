...
flags.DEFINE_integer('MAX_TO_KEEP', 2, 'The max number of model to save')
...
flags.DEFINE_string(
    'MODEL_DIR', 'Densenet_T2_mrilab_noise10e-3_1_TV_0.1_10.27',
    'If LOAD_MODEL, provide the MODEL_DIR. [./model/baseline/]'
)
flags.DEFINE_string(
    'DATA_DIR', '/data1/gcl/rotate_noe_chars_16/',
