...
def inference(input,is_training=True,reuse = False,args = None,name='UNet'):
    with tf.variable_scope(name, reuse=reuse):
        ...
        out = out + L2_Dense
        return out
def inference_incep(input,is_training=True,reuse = False,args = None,name='UNet'):
    with tf.variable_scope(name, reuse=reuse):
        ### NonLocal替代Dense
        L1_Dense = NonLocal(input,2,name='Dense1')
        L2_Dense = NonLocal(L1_Dense,2,name='Dense2')
        ...
        L1_conv = conv_relu(L2_Dense,args.SPFILTER_DIM,k_h=1,k_w=7,name='conv_1')
        L1_1 = inception(L1_conv,FILTER_DIM,is_train=is_training, name='Conv2d_1_1')
        L1_2 = inception(L1_1, FILTER_DIM,is_train=is_training, name='Conv2d_1_2')
        L2_1 = tf.nn.max_pool(L1_2, [1, 1, 2, 1], [1, 1, 2, 1], padding = 'SAME',name = 'MaxPooling1')  ##

        L2_2 = inception(L2_1, FILTER_DIM*2,is_train=is_training, name='Conv2d_2_1')
        L2_3 = inception(L2_2, FILTER_DIM*2,is_train=is_training,name='Conv2d_2_2')
        L3_1 = tf.nn.max_pool(L2_3, [1, 1, 2, 1], [1, 1, 2, 1], padding = 'SAME',name = 'MaxPooling2')    ##

        L3_2 = inception(L3_1, FILTER_DIM*4,is_train=is_training,name='Conv2d_3_1')
        L3_3 =  inception(L3_2, FILTER_DIM*4,is_train=is_training,name='Conv2d_3_2')
        L4_1 = tf.nn.max_pool(L3_3, [1, 1, 2, 1], [1, 1, 2, 1], padding = 'SAME',name = 'MaxPooling3')    ##

        L4_2 = inception(L4_1, FILTER_DIM*8,is_train=is_training,name='Conv2d_4_1')
        L4_3 = inception(L4_2, FILTER_DIM*8,is_train=is_training,name='Conv2d_4_2')
        L5_1 = tf.nn.max_pool(L4_3, [1, 1, 2, 1], [1, 1, 2, 1], padding = 'SAME',name = 'MaxPooling4')  ##

        L5_2 = inception(L5_1, FILTER_DIM*16,is_train=is_training,name='Conv2d_5_1')
        L5_3 = inception(L5_2, FILTER_DIM*16,is_train=is_training,name='Conv2d_5_2')

        L4_U1 = ReLU(Deconv2d_bn(L5_3, L4_3.get_shape().as_list(),k_h = 1, strides =[1, 1, 2, 1],is_train=is_training,name = 'Deconv2d4'),name='DeReLU4')
        L4_U1 = tf.concat((L4_3, L4_U1), -1)
        L4_U2 = inception(L4_U1, FILTER_DIM * 8,is_train=is_training,name='Conv2d_4_u1')
        L4_U3 = inception(L4_U2, FILTER_DIM * 8,is_train=is_training,name='Conv2d_4_u2')

        L3_U1 = ReLU(Deconv2d_bn(L4_U3,L3_3.get_shape().as_list(),k_h = 1, strides =[1, 1, 2, 1],is_train=is_training,name = 'Deconv2d3'),name = 'DeReLU3')
        L3_U1 = tf.concat((L3_3, L3_U1), -1)
        L3_U2 = inception(L3_U1, FILTER_DIM*4,is_train=is_training, name='Conv2d_3_u1')
        L3_U3 = inception(L3_U2, FILTER_DIM*4,is_train=is_training, name='Conv2d_3_u2')

        L2_U1 = ReLU(Deconv2d_bn(L3_U3,L2_3.get_shape().as_list(), k_h = 1, strides =[1, 1, 2, 1],is_train=is_training,name = 'Deconv2d2'),name='DeReLU2')
        L2_U1 = tf.concat((L2_3, L2_U1), -1)
        L2_U2 = inception(L2_U1, FILTER_DIM*2,is_train=is_training,name='Conv2d_2_u1')
        L2_U3 = inception(L2_U2, FILTER_DIM*2,is_train=is_training,name='Conv2d_2_u2')

        L1_U1 = ReLU(Deconv2d_bn(L2_U3, L1_2.get_shape().as_list(),k_h = 1, strides =[1, 1, 2, 1],is_train=is_training,name='Deconv2d1'),name='DeReLU1')
        L1_U1 = tf.concat((L1_2, L1_U1), 3)
        L1_U2 = inception(L1_U1, FILTER_DIM, is_train=is_training,name='Conv1d_1_u1')
        L1_U3 = inception(L1_U2, FILTER_DIM, is_train=is_training,name='Conv1d_1_u2')
