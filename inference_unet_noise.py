...
def net(input,len):
    ...
    b11 = int_b(shape=[up_out1_channel],name='b11')
    ...
    b14 = int_b(shape=[up_out2_channel],name='b14')
    ...
    b17 = int_b(shape=[up_out3_channel],name='b17')
    ...
    b20 = int_b(shape=[up_out4_channel],name='b20')
    ...
    net_out = tf.nn.bias_add(conv23, b23)

    return net_out,relu2,relu6,relu10,relu16
