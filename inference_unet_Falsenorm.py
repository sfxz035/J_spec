...
def net(input,batch_size,len):
    ...
    relu5 = tf.nn.relu(tf.layers.batch_normalization(conv5))
    ...
    relu6 = tf.nn.relu(tf.layers.batch_normalization(conv6))
    ...
    relu7 = tf.nn.relu(tf.layers.batch_normalization(conv7))
    ...
    relu8 = tf.nn.relu(tf.layers.batch_normalization(conv8))
    ...
    relu9 = tf.nn.relu(tf.layers.batch_normalization(conv9))
    ...
    relu10 = tf.nn.relu(tf.layers.batch_normalization(conv10))
    ...
    relu11 = tf.nn.relu(tf.layers.batch_normalization(conv11))
    ...
    relu12 = tf.nn.relu(tf.layers.batch_normalization(conv12))
    ...
    relu13 = tf.nn.relu(tf.layers.batch_normalization(conv13))
    ...
    relu14 = tf.nn.relu(tf.layers.batch_normalization(conv14))
    ...
    relu15 = tf.nn.relu(tf.layers.batch_normalization(conv15))
    ...
    relu16 = tf.nn.relu(tf.layers.batch_normalization(conv16))
    ...
    relu17 = tf.nn.relu(tf.layers.batch_normalization(conv17))
    ...
    relu18 = tf.nn.relu(tf.layers.batch_normalization(conv18))
    ...
    relu19 = tf.nn.relu(tf.layers.batch_normalization(conv19))
    ...
    relu20 = tf.nn.relu(tf.layers.batch_normalization(conv20))
    ...
    relu21 = tf.nn.relu(tf.layers.batch_normalization(conv21))
    ...
    relu22 = tf.nn.relu(tf.layers.batch_normalization(conv22))
    ...
    # batch = tf.layers.batch_normalization(conv23)
    net_out = conv23
    return net_out
